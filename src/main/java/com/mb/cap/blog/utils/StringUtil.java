...
public class StringUtil {
     ...
     * @return the string
     */
    public static String join(Collection<String> array, char sparator) {
    ...
    public static String join(String[] array, String sparator) {
        return StringUtils.join(Arrays.asList(array), sparator.charAt(0));
    }
     ...
     * @return
     */
    public static String toUpperCaseNonSpaceNonAccent(String input) {
        return upperCase(remove(StringUtils.stripAccents(input), StringPool.SPACE, StringPool.BLANK));
    }
}
